...
public class MonumentFrontController {
    ...
    private void showMonumentDetails(Monument monument) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/MonumentDetails.fxml"));
    ...
    public void goToMonuments(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/MonumentFront.fxml"));
    ...
    private void populateCurrencyComboBox() {
        ...
        String[] flagImagePaths = {"image/usa.png", "image/euro.png", "image/uk.png", "image/tunisia.png"}; // Make sure to have these flag images in your resources folder
