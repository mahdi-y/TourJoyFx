...
public class SubscriptionService {
    ...
    public void subskrayb(int subscription) throws SQLException {
        UserSession session = UserSession.getInstance();
        String query = "INSERT INTO user_subscriptions (fk_subscription,fk_user) VALUES (?, ?)";
        ...
        try (Connection connection = MyDB.getInstance().getConnection();
            ...
            statement.setInt(2, subscription);
